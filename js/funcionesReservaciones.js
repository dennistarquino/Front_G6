function getReservaciones (){
    $.ajax({
        url:"http://152.67.255.91:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function putReservaciones(idDesdeBoton){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Reservation/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteReservaciones(data){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Reservation/"+data,
        type:"DELETE",
        datatype:"JSON",
...
function getClient_Reservation(){
    $.ajax({
        url:"http://152.67.255.91:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function getMachine_Reservation(){
    $.ajax({
        url:"http://152.67.255.91:8080/api/Machine/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
