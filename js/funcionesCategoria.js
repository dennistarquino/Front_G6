function getCategoria (){
    $.ajax({
        url:"http://152.67.255.91:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function postCategoria(){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Category/save",
        type:"POST",
        datatype:"JSON",
...
function putCategoria(idDesdeBoton){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Category/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteCategoria(idDesdeBoton){
    ...
    $.ajax({
        url:"http://152.67.255.91:8080/api/Category/"+idDesdeBoton,
        type:"DELETE",
        datatype:"JSON",
